...
.nav-link.active { color: #1a5c52; text-decoration: underline; text-underline-offset: 3px; }
...
.footer-links a { font-size: 20px; color: #555; font-weight: 500; cursor: pointer; }
